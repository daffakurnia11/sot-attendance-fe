...
const valid = {
  discord_players: [{ member_id: 1, username: "delta", display_name: "Delta", character_name: "", started_at: null, status: "offline", total_playtime_seconds: 5400 }], player_threshold: 15, total_members: 4,
  total_playtime_seconds: 5400, total_attended: 2, total_attendances: 3,
  cfx_players: [], cfx_available: true,
};
