...
export function SectionHeader({ eyebrow, index, title }: SectionHeaderProps) {
  ...
  return (
    <div className="grid grid-cols-[34px_1fr] items-center gap-3 sm:grid-cols-[38px_auto_1fr]">
      <span className="grid h-[34px] w-[34px] place-items-center border border-[var(--color-border)] bg-[rgba(242,182,61,.07)] text-xs font-black text-[var(--color-primary)] sm:h-[38px] sm:w-[38px]">
        {index}
      </span>
